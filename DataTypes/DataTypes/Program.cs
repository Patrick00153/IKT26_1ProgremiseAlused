...
namespace DataTypes
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //string e tahemarkide jada, mis on defineeritud andmetüüpiga string
            //andmetüüp toetab ainult true ja false väärtusi
            //myString on mutuja, mis on defineeritud andmetüüpiga string
            //saab sisestada kõike, mis on klaviatuuril
            string myString = "Hello, World!";
            //kirjutage cw ja vajutage tab, et genereerid Console.Writeline
            ...
            //double on ujukomaarvuline andmetüüo, mis toetab ainult ujukomaarve
            double myDouble = 5.5;
            ...
            //Short on täisarvuline andmetüüp, mis toetab ainuly täisarve
